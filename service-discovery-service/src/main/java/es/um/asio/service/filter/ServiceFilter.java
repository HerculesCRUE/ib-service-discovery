...
public class ServiceFilter extends AbstractJpaSpecification<ServiceEnt> implements EntityFilter {
    ...
    @Override
    public Predicate toPredicate(final Root<ServiceEnt> root, final CriteriaQuery<?> query,
