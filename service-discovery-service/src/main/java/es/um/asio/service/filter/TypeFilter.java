...
public class TypeFilter extends AbstractJpaSpecification<TypeEnt> implements EntityFilter {
    ...
    @Override
    public Predicate toPredicate(final Root<TypeEnt> root, final CriteriaQuery<?> query,
